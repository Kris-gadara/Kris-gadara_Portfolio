...
const Hero = () => {
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Kris-gadara',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/kris-gadara-1580b9343/',
      icon: (
        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:krishgadara0701@gmail.com',
      icon: (
        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Portfolio',
      url: 'https://krisgadara-portfolio.vercel.app/',
      icon: (
        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section id="home" className="hero">
      <div className="hero-container container">
        ...
        >
          ...
          >
            <span className="gradient-text">KRISKUMAR GADARA</span>
          </motion.h1>
